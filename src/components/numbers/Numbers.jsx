  ...
  const states = [
    {
      ...
      first: {
        height: 341,
        numberClass: "text-[320px] leading-[288px] tracking-[-20px] number-base number-large",
        textClass: "text-[60px] leading-[60px] tracking-[-2.4px]",
        paddingNumber: "pb-[52px]",
        paddingText: "pb-[52px]",
        iconClass: "top-[25px]",
        iconSize: "w-[26px] h-[60px]",
        iconPath: "M14 0.839996V55.34L24.5 44.84L26 46.16L13 59.16L0 46.16L1.5 44.84L12 55.34V0.839996H14Z",
        viewBox: "0 0 26 60",
        // marginClass: "my-[38px]",
        gap: 48,
      },
        ...
        <div className="my-[90px] px-[32px] z-30 relative w-full">
          ...
          >
            ...
            <div className="flex items-end justify-center relative transition-all duration-600 ease-in-out" style={{ gap: `${currentState.first.gap}px` }}>
              ...
              >
                +350
                <span className="number-gradient-overlay">+350</span>
              </p>
              <p
          ...
          >
            <div className={`absolute ${currentState.second.iconClass} right-[10px] transition-all duration-600 ease-in-out`}>
              ...
              >
                <path
                  d={currentState.second.iconPath}
                  fill="#7D7F83"
                />
              </svg>
            </div>
            <div className="flex items-end justify-center relative transition-all duration-600 ease-in-out" style={{ gap: `${currentState.second.gap}px` }}>
              ...
              >
                +150
                <span className="number-gradient-overlay">+150</span>
              </p>
              <p
          ...
          >
            ...
            <div className="flex items-end justify-center relative transition-all duration-600 ease-in-out" style={{ gap: `${currentState.third.gap}px` }}>
              ...
              >
                250k
                <span className="number-gradient-overlay">250k</span>
              </p>
              <p
